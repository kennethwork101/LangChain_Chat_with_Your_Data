...
def Options():
    ...
    parser.add_argument('--embedding', type=str, help='embedding: chroma gpt4all huggingface')
...
#       "huggingface",
    ...
    parser.add_argument('--pathname', type=str, help='pathname', default=f'{_path}data/data_all/')
    parser.add_argument('--question', type=str, help='question', default='What did they say about matlab?')
    parser.add_argument('--repeatcnt', type=int, help='repeatcnt', default=1)
    parser.add_argument('--temperature', type=float, help='temperature', default=0.1)
    parser.add_argument('--vectordb_type', type=str, help='vectordb_type', default='disk')
